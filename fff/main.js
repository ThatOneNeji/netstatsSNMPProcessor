...
/* Logging setup */
var genLogger = log4js.getLogger('General'),
    amqpLogger = log4js.getLogger('amqp'),
    snmpLogger = log4js.getLogger('snmp'),
...
function makeMacAddr(mac_add_raw) {
    var str = mac_add_raw;
    genLogger.warn('11');
    genLogger.error(mac_add_raw);
    genLogger.warn('22');
    if (typeof mac_add_raw !== 'undefined' && mac_add_raw) {
